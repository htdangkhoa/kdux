...
import com.github.htdangkhoa.demo.ui.counter_thunk.CounterThunkActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnGoToCounterThunk.setOnClickListener {
            startActivity(
                Intent(this, CounterThunkActivity::class.java)
                    .apply {
                        addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT)
                    }
            )
